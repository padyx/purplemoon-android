...
public class ConversationStatusLoader extends SimpleAsyncLoader<Holder<UserMessageHistoryBean>> {
    ...
    public ConversationStatusLoader(Context context, Bundle b) {
    ...
    public Holder<UserMessageHistoryBean> loadInBackground() {
        try{
            UserMessageHistoryBean bean = PurplemoonAPIAdapter.getInstance().getConversationStatus(m_profileId);
