...
public enum SearchCriteria {
    ...
    HEIGHT(SearchCriteriaType.MIN_MAX_INT, true, R.string.profileKeyText_height),
    WEIGHT(SearchCriteriaType.MIN_MAX_INT, true, R.string.profileKeyText_weight),
    BMI(SearchCriteriaType.MIN_MAX_INT, true, 0), //XXX
    PHYSIQUE(SearchCriteriaType.LIST, true, R.string.profileKeyText_physique),
    EYE_COLOR(SearchCriteriaType.LIST, true, R.string.profileKeyText_eye_color),
