...
public enum SearchCriteria {
    ...
    DRINKER(SearchCriteriaType.LIST, true, R.string.profile_drinker),
    SMOKER(SearchCriteriaType.LIST, true, R.string.profile_smoker),
    VEGETARIAN(SearchCriteriaType.LIST, true, R.string.profile_vegetarian),
    KIDS_WANT(SearchCriteriaType.LIST, true, R.string.profile_kids_want),
    KIDS_HAVE(SearchCriteriaType.LIST, true, R.string.profile_kids_have),
    RELIGION(SearchCriteriaType.LIST, true, R.string.profile_religion),
    POLITICS(SearchCriteriaType.LIST, true, R.string.profile_politics),
